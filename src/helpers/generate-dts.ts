...
// 生成的代码缩进 一个tab
const indent = Config.INDENT_STR;
...
function _getRenderInterface(name) {
    if ((globalExportMode === Config.EXPORT_DEFAULT && name === globalInterfaceNamePrefix + interfaceName) || name === globalInterfaceNamePrefix + interfaceName) { // export default 只能导出第一级
...
* @param interfaceNamePrefix 接口名前缀，默认I
* @returns {*}
*/
